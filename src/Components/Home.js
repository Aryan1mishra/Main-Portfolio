...
function Home() {
  ...
  const socialLinks = [
    ...
    { icon: <FaFileAlt />, link: "https://drive.google.com/file/d/1NQMxI0if8nrMAkqbB_VgDaqG5zPw_lbI/view?usp=sharing", angle: 288 },
  ];
      ...
      <div className="w-full md:w-1/2 text-center md:text-left md:pl-10">
        ...
        <TypeAnimation
          sequence={[
            ...
            1000,
            "I'm a Data Science / Analysis enthusiast",
            1000,
        ...
        <p className="text-base sm:text-lg leading-relaxed text-slate-700 ">
          Aspiring AI/ML and Data Science professional with hands-on experience in data analysis, predictive modeling, and machine learning using Python, Pandas, and Scikit-learn. Gained practical industry exposure through a summer internship working with real-world datasets and end-to-end ML pipelines. Additionally skilled in full-stack web development using React and Node.js, enabling the development of data-driven, scalable applications.
